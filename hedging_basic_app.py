...
if simulate_btn:
    ...
    summary = pd.DataFrame({
        "Strategy": ["Unhedged", "Hedge-at-0", "Hedge one year before cash flow"],
    ...
    st.markdown("#### PV Profit — Overlayed Distributions (Hedge-at-0 vs Hedge one year before cash flow)")
    ...
    if A.size and B.size:
        ...
        plt.hist(B, bins=40, alpha=0.5, label="Hedge one year before cash flow")
...
if hsweep_btn:
    ...
    plt.scatter(fb["std"], fb["mean"], label="Hedge one year before cash flow")
