...
st.title("Taylor Rule Simulator (with Interest Rate Smoothing)")
st.write(
    "Upload a CSV and explore the Taylor Rule with **interest rate smoothing**. "
    "You can choose the inflation series (Headline, Core CPI, Core PCE) and adjust parameters."
)
...
rho = st.sidebar.slider("Interest rate smoothing ρ", min_value=0.0, max_value=0.99, value=0.8, step=0.01,
